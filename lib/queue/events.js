...
/**
 *
 * Events which are emitted when the job is finally done
 */

var doneEvents = exports.doneEvents = ['complete','failed'];
...
exports.onMessage = function(channel, msg){
  ...
  if (job) {
    ...
    if (doneEvents.indexOf(msg.event) !== -1) delete exports.jobs[job.id];
  }
